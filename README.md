...
**📖 View the full notebook in your browser (no download needed):**
https://manidixit16.github.io/aimlassignment/Wine_Quality_Comparative_Study_Mani_PGDSAI3.html

## Contents

- `Wine_Quality_Comparative_Study_Mani_PGDSAI3.ipynb` — full notebook: Section 1 + Tasks 1–7, executed with all outputs shown
- `Wine_Quality_Comparative_Study_Mani_PGDSAI3.html` — HTML export of the executed notebook, served via GitHub Pages at the link above (also viewable offline in any browser if GitHub's notebook preview fails to load)
